...
public class EmployeeValidator {
    ...
    public boolean isValid(Employee employee) {
        ...
        boolean isAgeValid = employee.getAge().matches("[0-9]+") && (employee.getAge().length() > 1) && (Integer.parseInt(employee.getAge()) > 18 && (Integer.parseInt(employee.getAge()) < 80));
        ...
        return isFirstNameValid && isLastNameValid && isAgeValid && isCNPValid && isFunctionValid && isSalaryValid;
    }
